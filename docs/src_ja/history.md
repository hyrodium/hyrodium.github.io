...
- Maker Faire Tokyo 2025
    ...
    - 場所: 東京ビッグサイト
    - [上木敬士郎](https://keishiroueki.net/ja/home-ja/)さんと共同出展の予定でしたが、私はコロナになって参加できませんでした。
    - [個別ページ]([準備中](https://makezine.jp/event/makers-mft2025/m0004/)), [イベントページ](https://makezine.jp/event/mft2025/)
- 3DPの集い in 大阪
    - 日程: 2025-09-13
    - 3Dプリンタ関連作品を出展しました。展示番号はB16でした。
    - 場所: 大阪市中央公会堂
